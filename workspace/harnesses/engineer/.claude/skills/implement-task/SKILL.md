...
1. The current directory is this Task's workspace, shared across whichever agents work on it — check for existing files before starting, and build on them rather than ignoring them.
